...
## Testing & Quality
- **Unit Testing:** Recommended for core utility functions (e.g., pricing calculators, date formatters).
- **Manual Verification:** Every feature task must be manually verified by the user upon completion.
- **Accessibility:** All UI components must be checked for basic WCAG compliance (alt tags, aria-labels).
