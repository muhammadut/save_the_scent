...
const Navbar = () => {
  ...
  return (
    ...
    >
      <button className="group flex items-center gap-3 bg-[#faf8f5]/95 backdrop-blur-sm text-[#181717] px-6 py-3 rounded-full font-medium transition-all duration-500 hover:bg-[#e8b4b8] hover:gap-4 shadow-2xl">
